...
!function(t, e) {
        ...
        roundedRect: function(t, e, n, i, a, r) {
            if (r) {
                var o = Math.min(r, a / 2, i / 2)
                  ...
                  , d = n + a - o;
                t.moveTo(e, l),
                s < u && l < d ? (t.arc(s, l, o, -P, -A),
                t.arc(u, l, o, -A, 0),
                t.arc(u, d, o, 0, A),
                t.arc(s, d, o, A, P)) : s < u ? (t.moveTo(s, n),
                t.arc(u, l, o, -A, A),
                t.arc(s, l, o, A, P + A)) : l < d ? (t.arc(s, l, o, -P, 0),
    ...
    var dt = $.extend({
        _type: "line",
        draw: function() {
            var t, e, n, i = this, a = i._view, r = i._chart.ctx, o = a.spanGaps, s = i._children.slice(), l = W.global, u = l.elements.line, d = -1, h = i._loop;
            if (s.length) {
                if (i._loop) {
    ...
    var Kt = it.extend({
        ...
        _resolveDatasetElementOptions: function() {
            ...
            return i.spanGaps = Xt(e.spanGaps, n.spanGaps),
    ...
    })) && ge.default || ge, ve = "$chartjs", be = "chartjs-size-monitor", ye = "chartjs-render-monitor", xe = "chartjs-render-animation", _e = ["animationstart", "webkitAnimationStart"], we = {
        ...
        descriptors: function(t) {
            ...
            return this._plugins.concat(a.plugins || []).forEach((function(t) {
                if (-1 === n.indexOf(t)) {
                    var e = t.id
                      , a = r[e];
                    !1 !== a && (!0 === a && (a = H.clone(W.global.plugins[e])),
                    n.push(t),
                    i.push({
                        plugin: t,
                        options: a || {}
    ...
    var je = $.extend({
        ...
        update: function(t) {
            var e, n, i, a, r, o, s, l, u, d, h = this, c = h._options, f = h._model, g = h._model = Ve(c), m = h._active, p = h._data, v = {
                xAlign: f.xAlign,
                yAlign: f.yAlign
            }, b = {
                x: f.x,
        ...
        drawBody: function(t, e, n) {
            var i, a, r, o, s, l, u, d, h = e.bodyFontSize, c = e.bodySpacing, f = e._bodyAlign, g = e.body, m = e.displayColors, p = 0, v = m ? He(e, "left") : 0, b = We(e.rtl, e.x, e.width), y = function(e) {
    ...
    H.extend(tn.prototype, {
        ...
        updateLayout: function() {
            var t = this;
            !1 !== Le.notify(t, "beforeLayout") && (me.update(this, this.width, this.height),
            t._layers = [],
    ...
    var yn = $.extend({
        ...
        _getLabelSizes: function() {
            var t = this
              , e = t._labelSizes;
            return e || (t._labelSizes = e = cn(t.ctx, pn(t.options.ticks), t.getTicks(), t.longestTextCache),
        ...
        _computeGridLineItems: function(t) {
            var e, n, i, a, r, o, s, l, u, d, h, c, f, g, m, p, v, b = this, y = b.chart, x = b.options, _ = x.gridLines, w = x.position, k = _.offsetGridLines, M = b.isHorizontal(), S = b._ticksToDraw, D = S.length + (k ? 1 : 0), C = fn(_), P = [], T = _.drawBorder ? dn(_.lineWidth, 0, 0) : 0, O = T / 2, A = H._alignPixel, F = function(t) {
                return A(y, t, T)
            };
            ...
            n = 0; n < D; ++n)
                i = S[n] || {},
                ln(i.label) && n < S.length || (n === b.zeroLineIndex && x.offset === k ? (g = _.zeroLineWidth,
                m = _.zeroLineColor,
                ...
                void 0 !== (a = hn(b, i._index || n, k)) && (r = A(y, a, g),
        ...
        _computeLabelItems: function() {
            var t, e, n, i, a, r, o, s, l, u, d, h, c = this, f = c.options, g = f.ticks, m = f.position, p = g.mirror, v = c.isHorizontal(), b = c._ticksToDraw, y = pn(g), x = g.padding, _ = fn(f.gridLines), w = -H.toRadians(c.labelRotation), k = [];
        ...
        _drawTitle: function() {
            var t = this
              ...
              , i = n.scaleLabel;
            if (i.display) {
                var a, r, o = un(i.fontColor, W.global.defaultFontColor), s = H.options._parseFont(i), l = H.options.toPadding(i.padding), u = s.lineHeight / 2, d = n.position, h = 0;
                if (t.isHorizontal())
                    a = t.left + t.width / 2,
        ...
        buildTicks: function() {
            var t = this
              ...
              , a = t.ticks = function(t, e) {
                var n, i, a, r, o = [], s = t.stepSize, l = s || 1, u = t.maxTicks - 1, d = t.min, h = t.max, c = t.precision, f = e.min, g = e.max, m = H.niceNum((g - f) / u / l) * l;
                if (m < 1e-14 && Sn(d) && Sn(h))
                    return [f, g];
                (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = H.niceNum(r * m / u / l) * l),
                s || Sn(c) ? n = Math.pow(10, H._decimalPlaces(m)) : (n = Math.pow(10, c),
                m = Math.ceil(m * n) / n),
                i = Math.floor(f / m) * m,
                a = Math.ceil(g / m) * m,
                s && (!Sn(d) && H.almostWhole(d / m, m / 1e3) && (i = d),
    ...
    var Nn = xn.extend({
        ...
        handleTickRangeOptions: function() {
            ...
            t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(In(t.min)) - 1),
            t.max = Math.pow(10, Math.floor(In(t.max)) + 1)) : (t.min = 1,
            t.max = 10)),
        ...
        buildTicks: function() {
            var t = this
              ...
              , a = t.ticks = function(t, e) {
                var n, i, a = [], r = Fn(t.min, Math.pow(10, Math.floor(In(e.min)))), o = Math.floor(In(e.max)), s = Math.ceil(e.max / Math.pow(10, o));
                0 === r ? (n = Math.floor(In(e.minNotZero)),
                i = Math.floor(e.minNotZero / Math.pow(10, n)),
                a.push(r),
                r = i * Math.pow(10, n)) : (n = Math.floor(In(r)),
        ...
        getPixelForValue: function(t) {
            var e = this
              , n = 0;
            return (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (In(t) - e._startValue) / e._valueRange + e._valueOffset),
    ...
    var Zn = Dn.extend({
        ...
        _drawGrid: function() {
            var t, e, n, i = this, a = i.ctx, r = i.options, o = r.gridLines, s = r.angleLines, l = Yn(s.lineWidth, o.lineWidth), u = Yn(s.color, o.color);
            ...
            o.display && H.each(i.ticks, (function(t, n) {
                ...
                function(t, e, n, i) {
                    var a, r = t.ctx, o = e.circular, s = t.chart.data.labels.length, l = zn(e.color, i - 1), u = zn(e.lineWidth, i - 1);
                    if ((o || s) && l && u) {
                        if (r.save(),
                        r.strokeStyle = l,
                        r.lineWidth = u,
        ...
        _drawLabels: function() {
            var t = this
              ...
              , n = t.options.ticks;
            if (n.display) {
                var i, a, r = t.getIndexAngle(0), o = H.options._parseFont(n), s = Yn(n.fontColor, W.global.defaultFontColor);
                e.save(),
                e.font = o.string,
    ...
    var hi = xn.extend({
        ...
        update: function() {
            ...
            return Xn("time scale", n.format, "time.format", "time.parser"),
        ...
        determineDataLimits: function() {
            var t, e, n, i, a, r, o, s = this, l = s.chart, u = s._adapter, d = s.options, h = d.time.unit || "day", c = ti, f = Qn, g = [], m = [], p = [], v = s._getLabels();
            for (t = 0,
            n = v.length; t < n; ++t)
                p.push(li(s, v[t]));
            for (t = 0,
        ...
        buildTicks: function() {
            ...
            for (u = "data" === c || "auto" === c && "series" === f ? u.data : "labels" === c ? u.labels : function(t, e, n, i) {
                var a, r = t._adapter, o = t.options, s = o.time, l = s.unit || ui(s.minUnit, e, n, i), u = Kn([s.stepSize, s.unitStepSize, 1]), d = "week" === l && s.isoWeekday, h = e, c = [];
    ...
    rn._date.override("function" == typeof gi ? {
        ...
        parse: function(t, e) {
            return "string" == typeof t && "string" == typeof e ? t = gi(t, e) : t instanceof gi || (t = gi(t)),
    ...
    var Mi = {
        ...
        afterDatasetsUpdate: function(t, e) {
            ...
            for (i = 0; i < o; ++i)
                r = null,
                (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof wt.Line && (r = {
    ...
    var Ti = $.extend({
        ...
        draw: function() {
            var t = this
              ...
              , u = t.lineWidths;
            if (e.display) {
                var d, h = Si(e.rtl, t.left, t.minSize.width), c = t.ctx, f = Ci(n.fontColor, i.defaultFontColor), g = H.options._parseFont(n), m = g.size;
    ...
    var Ai = {
        ...
        beforeUpdate: function(t) {
            var e = t.options.legend
              , n = t.legend;
            e ? (H.mergeIf(e, W.global.legend),
            n ? (me.configure(t, n, e),
            n.options = e) : Oi(t, e)) : n && (me.removeBox(t, n),
            delete t.legend)
        },
    ...
    var Ri = {}
      ...
      , Yi = {
        ...
        beforeUpdate: function(t) {
            var e = t.options.title
              , n = t.titleBlock;
            e ? (H.mergeIf(e, W.global.title),
            n ? (me.configure(t, n, e),
            n.options = e) : Li(t, e)) : n && (me.removeBox(t, n),
            delete t.titleBlock)
        }
    };
    ...
    function() {
        ...
        H.color = k ? function(t) {
            return t instanceof CanvasGradient && (t = W.global.defaultColor),
            k(t)
        }
        : function(t) {
